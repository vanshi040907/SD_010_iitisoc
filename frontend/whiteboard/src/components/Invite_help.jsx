...
import {
  ...
  MessageCircle, Smile, LogOut, Sun, Trash2, Sparkles, HelpCircle, X, Copy, Link, Check
} from "lucide-react";
...
function SharePopup({ onClose }) {
  ...
  const copy = (text, setter) => {
    navigator.clipboard.writeText(text).catch(() => {
      console.log("Error!! Unable to copy due to restricted permissions. ");
    });
    setter(true);
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`w-11 h-11 rounded-xl flex items-center justify-center border transition-all duration-200 flex-shrink-0 ${codeCopied
                  ? `${theme.copied}`
...
const SHORTCUTS = [
  ...
  },
  {
    key: "Ctrl + Shift + Z",
    title: "Redo",
    desc: "Redo the last undone action (Mac compatible).",
  },
  {
    key: "Esc",
    title: "Deselect",
    desc: "Deselect the currently selected object.",
  },
  {
    key: "V",
    title: "Select Tool",
    desc: "Switch to the Select tool.",
  },
  {
    key: "P",
    title: "Pen Tool",
    desc: "Switch to the Pen tool.",
  },
  {
    key: "E",
    title: "Eraser",
    desc: "Switch to the Eraser.",
  },
  {
    key: "H",
    title: "Highlighter",
    desc: "Switch to the Highlighter.",
  },
  {
    key: "S",
    title: "Sticky Note",
    desc: "Switch to the Sticky Note tool.",
  },
  {
    key: "X",
    title: "Text Tool",
    desc: "Switch to the Text tool.",
  },
  {
    key: "R",
    title: "Rectangle",
    desc: "Select Rectangle from the Shape tool.",
  },
  {
    key: "C",
    title: "Circle",
    desc: "Select Circle from the Shape tool.",
  },
  {
    key: "T",
    title: "Triangle",
    desc: "Select Triangle from the Shape tool.",
  },
  {
    key: "L",
    title: "Line",
    desc: "Select Line from the Shape tool.",
  },
]
          ...
          <div>
            <div className="flex gap-2 mb-4">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs font-semibold transition-all ${activePage === "features"
                  ? "bg-purple-600 text-white"
                  : "bg-transparent border border-purple-500/20 text-purple-300"
                  }`}
              >
                Features
              </button>
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-xs font-semibold transition-all ${activePage === "shortcuts"
                  ? "bg-purple-600 text-white"
                  : "bg-transparent border border-purple-500/20 text-purple-300"
                  }`}
              >
            ...
            <div className="flex flex-col gap-2">
              {activePage === "features" && FEATURES.map((feature) => {
              ...
              {activePage === "shortcuts" && SHORTCUTS.map((shortcut) => (
                <div
                  key={shortcut.title}
                  className={`flex items-start gap-3 px-4 py-3 rounded-xl border ${theme.popupBorder}`}
                  style={{ background: "rgba(255,255,255,0.03)" }}
                >
                  ...
                  <div
                    className="min-w-[65px] h-9 rounded-lg
bg-purple-600/15
...
text-black-300">
                  ...
                  <div>
                    ...
                    <p className={`${theme.textPrimary} text-xs font-semibold`}>
                      {shortcut.title}
                    </p>

                    <p className={`${theme.textSecondary} text-xs mt-0.5 leading-relaxed`}>
                      {shortcut.desc}
                    </p>
